...
export class ProviderOperationalHardening2020000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE UNIQUE INDEX IF NOT EXISTS "IDX_jobs_user_provider_external"
    ...
    await queryRunner.query(`
      CREATE UNIQUE INDEX IF NOT EXISTS "IDX_jobs_user_canonical_url"
      ON "jobs" ("userId", "canonicalUrl")
      WHERE "canonicalUrl" IS NOT NULL
    `);

    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_jobs_user_dedupe_hash"
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE UNIQUE INDEX IF NOT EXISTS "IDX_jobs_source_provider_external"
