      ...
      <section id="compatibility-form" data-testid="landing-analysis-block" className="scroll-mt-24 bg-transparent">
        <div className="mx-auto w-full max-w-[1200px] px-4 pt-3 pb-8 md:px-10 md:pt-4 md:pb-10 lg:px-16">
          <div
            ...
            className="mx-auto max-w-4xl rounded-[24px] border border-slate-600/60 bg-slate-900/90 p-6 shadow-[0_18px_40px_rgba(2,6,19,0.55)] md:p-7"
          >
            ...
            <span className="sr-only" data-testid="landing-flow-state">
              {flowState}
            </span>
            <div className="mt-6 space-y-6">
              <div className="rounded-[18px] border border-slate-600/50 bg-slate-950/35 p-5 shadow-[0_10px_24px_rgba(2,6,23,0.35)]">
                ...
                <p className="mt-3 text-xs text-slate-500">
                  We extract text from your PDF/DOCX to score against the role.
                </p>
                <input
                  ref={fileInputRef}
                  type="file"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  onPaste={resetTextareaScrollTop}
                  ...
                  className="mt-2 h-[168px] w-full resize-none rounded-xl border border-slate-700/80 bg-slate-950/70 px-4 py-3 text-sm text-slate-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] focus:border-white/60 focus:outline-none"
                />
                <div className="mt-3">
                  <p className="text-xs text-slate-400">Use the full posting so the score and gaps are precise.</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                {hasResult ? (
                  <button
                    ...
                    aria-label="Show me what’s missing"
                    data-testid="landing-primary-action"
                    className="inline-flex w-full items-center justify-center rounded-lg bg-white px-4 py-3 text-sm font-semibold text-slate-950 shadow-[0_10px_30px_rgba(15,23,42,0.45)] transition hover:bg-slate-100"
                  >
                ...
                {typeof previewScore === "number" ? (
                  <div className="mt-3 space-y-4" data-testid="landing-result-state">
                    <div
                      data-testid="landing-preview-score"
                      className={`relative overflow-hidden rounded-[28px] border border-white/12 bg-[radial-gradient(120%_90%_at_50%_0%,rgba(99,102,241,0.28)_0%,rgba(255,255,255,0.03)_55%,rgba(255,255,255,0.02)_100%)] px-6 py-6 text-slate-100 shadow-[0_22px_70px_rgba(2,6,23,0.62)] backdrop-blur transition-all duration-300 ${
                        revealStage === "shown" ? "opacity-100 translate-y-0" : "opacity-0 translate-y-1"
                      }`}
                    >
                      ...
                      <div className="mt-3 flex items-end gap-3">
                        <div className="text-6xl font-semibold tracking-tight text-white" data-testid="landing-score-number">
                          {previewScore}
                        </div>
                        <div className="pb-2 text-sm font-medium text-slate-300">/ 100</div>
                      </div>
                      <div className="mt-3 text-xl font-semibold text-white" data-testid="landing-fit-label">
                        {fitLabel ?? "Fit signal"}
                      </div>
                      <div className="mt-1 text-sm text-slate-300" data-testid="landing-supporting-line">
                        {supportingLine ?? ""}
                      </div>
                    </div>
                    ...
                    {revealStage === "shown" ? (
                      <p
                        data-testid="landing-personalization-hook"
                        className="px-1 text-sm text-slate-300"
                      >
                    ...
                    <div
                      ...
                      className={`overflow-hidden rounded-2xl border border-white/8 bg-slate-950/25 px-5 py-4 shadow-[0_10px_25px_rgba(2,6,23,0.28)] transition-[opacity,max-height,transform] duration-300 ${
                        revealStage === "shown"
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div
                          aria-hidden="true"
                          className="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-white/[0.03] text-slate-200"
                        >
                        ...
                        <div>
                          <p className="text-base font-semibold text-white">
                            But your score doesn’t tell the whole story.
                          </p>
                          <p className="mt-1 text-sm text-slate-300">
                            Some candidates with similar scores still don’t get interviews.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div
                      data-testid="landing-gated-insights"
                      className="rounded-[22px] border border-white/12 bg-white/[0.02] px-5 py-5 shadow-[0_14px_40px_rgba(2,6,23,0.45)]"
                    >
                      <p className="text-xs text-slate-400" data-testid="landing-legitimacy-line">
                        We analyzed your resume against this job’s requirements.
                      </p>
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div
                          aria-hidden="true"
                          className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-slate-950/40 text-slate-200"
                        >
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                            <path
                      ...
                      <div className="mt-4 space-y-3" aria-hidden="true">
                        <div className="relative overflow-hidden rounded-xl border border-white/10 bg-slate-950/45 px-4 py-3">
                          <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-300/80 blur-[0.6px]">
                          ...
                          <div className="pointer-events-none absolute -left-24 top-0 h-full w-24 -skew-x-12 bg-white/8 blur-xl animate-pulse" />
                        </div>
                        <div className="relative overflow-hidden rounded-xl border border-white/10 bg-slate-950/45 px-4 py-3">
                          <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-300/80 blur-[0.6px]">
                            Role expectation gaps
                          </div>
                        ...
                        <div className="relative overflow-hidden rounded-xl border border-white/10 bg-slate-950/45 px-4 py-3">
                          <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-300/80 blur-[0.6px]">
                            Why you may not get interviews
                          </div>
                ...
                {showDebug ? (
                  <details className="rounded-xl border border-amber-300/25 bg-amber-500/5 px-3 py-2 text-[11px] leading-5 text-amber-200">
                    <summary className="cursor-pointer select-none text-[11px] font-semibold uppercase tracking-[0.14em] text-amber-200/90">
                      Debug diagnostics
                    </summary>
                    <div className="mt-2">
                        ...
                        <>
                          ...
                          <div>
                            ...
                            {debugState.lastError
                              ? `${debugState.lastError.code}: ${debugState.lastError.message}`
                              : "(none)"}
                          </div>
                        </>
                      ) : null}
