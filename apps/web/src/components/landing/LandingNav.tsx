          ...
          {isAuthenticated ? (
            ...
            <>
              <Link
                ...
                className="inline-flex items-center justify-center rounded-lg border border-slate-500 bg-white/5 px-3 py-2 text-sm font-semibold text-white transition hover:border-slate-300 hover:bg-white/10"
              >
                Sign in
              </Link>
              <Link
