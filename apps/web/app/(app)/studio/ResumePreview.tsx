          ...
          {isEditing ? (
            <>
             ...
             <button
               ...
               className="relative z-10 pointer-events-auto rounded-xl border border-white/15 px-3 py-2 text-sm font-medium text-slate-200 transition hover:border-white/30 hover:text-white"
